...
import com.sfinal.aop.ClearLayer.ClearLayer
 ...
 */
class ClearInterceptor(value: ClearLayer) extends scala.annotation.Annotation with scala.annotation.StaticAnnotation
