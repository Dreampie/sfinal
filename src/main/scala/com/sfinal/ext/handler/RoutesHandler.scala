...
class RoutesHandler extends Handler {
  def addRoute(regex: String, controllerKey: String) {
    throw new RuntimeException("Not finished")
  }

  def addRoute(regex: String, controllerKey: String, method: String) {
    throw new RuntimeException("Not finished")
  }

  def addRoute(regex: String, controller: Controller, method: String) {
    throw new RuntimeException("Not finished")
  }
